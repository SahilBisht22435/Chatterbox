...
const Signup = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("cloud_name", "dzqyq1pp3");
//CLOUDINARY_URL=cloudinary://<your_api_key>:<your_api_secret>@dzqyq1pp3
      fetch("https://api.cloudinary.com/v1_1/dzqyq1pp3/image/upload", {
        method: "POST",
        body: data,
      })
        .then((res) => res.json())
